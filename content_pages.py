...
<div class="content-section">
    ...
    <ul>
        ...
        <li><strong>Syariah-Principled structure</strong> — GigHala's escrow does not charge
...
"""
    ...
    def halal_marketplace_explained():
        ...
        content = """
<div class="content-section">
    <h2><span class="icon">🌙</span> What Makes a Service Marketplace "Built on Islamic Economic Principles"?</h2>
    <p>
        A service marketplace built on Islamic Economic Principles is one where the <strong>platform
...
<div class="content-section">
    <h2><span class="icon">🔍</span> GigHala's Syariah-Principled System</h2>
    <p>
        ...
        Syariah-Principled guidelines. Gigs that raise concerns are flagged for manual review
        before going live.
    </p>
    <div class="highlight-box">
        <p><strong>Syariah-Principled Verified badge:</strong> Workers who complete GigHala's
        optional Syariah-Principled verification process earn a badge on their profile,
...
<div class="content-section">
    ...
    <p>
        ...
        are central to many Malaysians' financial decisions. A Syariah-Principled
    ...
    <p>
        ...
        integrate a dedicated Designed to uphold Syariah principles — making it the platform
...
"""
        return render_template(
            ...
            user=user,
            active_page='content',
            page_title='How Syariah-Principled Service Marketplaces Work',
            page_subtitle='Explore what makes GigHala Malaysia\'s first truly gig marketplace built on Islamic Economic Principles.',
            content=content,
        )
...
<div class="content-section">
    ...
    <ul>
        ...
        <li><strong>Designed to uphold Syariah principles</strong> — All services on GigHala are
