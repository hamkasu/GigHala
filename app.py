...
TRANSLATIONS = {
    'ms': {
        ...
        'category_voice-acting': 'Lakonan Suara',
        'category_mobile-apps': 'Pembangunan Aplikasi Mudah Alih',
        'category_game-dev': 'Pembangunan Permainan',
        'category_3d-modeling': 'Pemodelan 3D',
        'category_fashion': 'Fesyen & Penggayaan',
        'category_fitness': 'Latihan Kecergasan',
        'category_cooking': 'Masakan & Makanan',
        'category_language': 'Pembelajaran Bahasa',
        'category_interior': 'Reka Bentuk Dalaman',
        'category_beauty': 'Kecantikan & Solek',
        'category_podcast': 'Pengeluaran Podcast',
        'category_transcription': 'Transkripsi',
        'category_illustration': 'Ilustrasi',
        'category_gaming': 'Bimbingan Permainan',
        'category_ai-automation': 'AI & Automasi',
        'category_elearning': 'Kandungan E-Pembelajaran',
    ...
    'en': {
        ...
        'category_voice-acting': 'Voice Acting',
        'category_mobile-apps': 'Mobile App Development',
        'category_game-dev': 'Game Development',
        'category_3d-modeling': '3D Modeling',
        'category_fashion': 'Fashion & Styling',
        'category_fitness': 'Fitness Training',
        'category_cooking': 'Cooking & Food',
        'category_language': 'Language Learning',
        'category_interior': 'Interior Design',
        'category_beauty': 'Beauty & Makeup',
        'category_podcast': 'Podcast Production',
        'category_transcription': 'Transcription',
        'category_illustration': 'Illustration',
        'category_gaming': 'Gaming Coaching',
        'category_ai-automation': 'AI & Automation',
        'category_elearning': 'E-Learning Content',
...
def init_database():
    ...
    try:
        ...
        default_categories = [
            ...
            Category(name='Voice Acting', slug='voice-acting', description='Voice overs, narration, dubbing, voice recording', icon='mic'),
            Category(name='Mobile App Development', slug='mobile-apps', description='iOS, Android app development, mobile solutions', icon='smartphone'),
            Category(name='Game Development', slug='game-dev', description='Game design, development, testing, Unity, Unreal', icon='gamepad'),
            Category(name='3D Modeling', slug='3d-modeling', description='3D design, modeling, rendering, product visualization', icon='box'),
            Category(name='Fashion & Styling', slug='fashion', description='Fashion advice, personal styling, wardrobe consulting', icon='shirt'),
            Category(name='Fitness Training', slug='fitness', description='Personal training, workout plans, fitness coaching', icon='activity'),
            Category(name='Cooking & Food', slug='cooking', description='Cooking lessons, recipe development, meal planning', icon='coffee'),
            Category(name='Language Learning', slug='language', description='Language tutoring, conversation practice, accent training', icon='globe'),
            Category(name='Interior Design', slug='interior', description='Home design, space planning, decoration consulting', icon='layout'),
            Category(name='Beauty & Makeup', slug='beauty', description='Makeup tutorials, beauty consulting, styling services', icon='star'),
            Category(name='Podcast Production', slug='podcast', description='Podcast editing, production, audio mastering', icon='radio'),
            Category(name='Transcription', slug='transcription', description='Audio transcription, subtitles, document conversion', icon='file-text'),
            Category(name='Illustration', slug='illustration', description='Digital illustration, character design, artwork', icon='feather'),
            Category(name='Gaming Coaching', slug='gaming', description='Game coaching, esports training, strategy guides', icon='target'),
            Category(name='AI & Automation', slug='ai-automation', description='AI tools, automation, chatbots, workflow optimization', icon='cpu'),
            Category(name='E-Learning Content', slug='elearning', description='Course creation, educational content, training materials', icon='book-open'),
        ]
